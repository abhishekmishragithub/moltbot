...
export const DEFAULT_SMALLESTAI_AUDIO_BASE_URL = "https://api.smallest.ai";
export const DEFAULT_SMALLESTAI_AUDIO_MODEL = "pulse";

function resolveModel(model?: string): string {
  const trimmed = model?.trim();
  return trimmed || DEFAULT_SMALLESTAI_AUDIO_MODEL;
}
...
export async function transcribeSmallestaiAudio(
  ...
  const baseUrl = normalizeBaseUrl(params.baseUrl, DEFAULT_SMALLESTAI_AUDIO_BASE_URL);
